...
public class TeachersService {
    ...
    //to know the present age of the teacher
    public Optional<Integer> getTeacherAgeById(long teacherId) {
        Optional<Teachers> teacher = teachersRepository.findById(teacherId);
        return teacher.map(t -> Period.between(t.getDateOfBirth(), LocalDate.now()).getYears());
    }
}
